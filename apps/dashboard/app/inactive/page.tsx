        ...
        <div className="flex items-stretch gap-3">
          <div className="grid flex-1 grid-cols-3 divide-x divide-white/[.07] rounded-xl border border-[#ED7D31]/25 bg-[#151A24]">
            <div className="flex flex-col justify-center gap-1 px-5 py-4">
              <span className="text-[12px] font-medium text-[#7A8496]">1주 이상 카톡방 멘션 없음</span>
              <span className="font-mono text-[30px] font-bold tracking-tight text-[#F2985C]">
                {data.totalInactive}
                <span className="ml-1 text-[15px] font-medium text-[#7A8496]">명</span>
              </span>
            </div>
            <div className="flex flex-col justify-center gap-1 px-5 py-4">
              <span className="text-[12px] font-medium text-[#7A8496]">2주 이상</span>
            ...
            <div className="flex flex-col justify-center gap-1 px-5 py-4">
              <span className="text-[12px] font-medium text-[#7A8496]">전체 회원 중 비율</span>
