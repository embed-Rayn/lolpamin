...
// 하한이 1/16인 이유: 물리 스텝은 배속과 무관하게 STEP_MS 고정이라 배속이 낮을수록 스텝
// 사이가 벌어진다. 1/16배속이면 60fps에서 약 0.27초에 한 스텝이라 슬로모션으로 읽히지만,
// 그보다 내려가면 스텝 간격이 초 단위가 되어 슬라이드쇼가 된다. 더 느리게 하려면 렌더
// 보간이 필요하다.
export const MIN_SPEED = 1 / 16;
